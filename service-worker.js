const VERSION='2.5.2',BASE='/pemilih-muda/',SHELL=`pemilih-muda-shell-${VERSION}`;
const APP_SHELL=['','index.html','materials.html','offline.html','manifest.webmanifest','css/variables.css','css/base.css','css/components.css','css/landing.css','css/materials.css','css/student.css','css/responsive.css','js/config.js','js/utils.js','js/api.js','js/auth.js','js/app.js','js/materials.js','js/install.js','js/bottom-nav.js','icons/icon-192.png','icons/icon-512.png','icons/apple-touch-icon.png'].map(path=>BASE+path);
