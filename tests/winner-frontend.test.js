...
assert.match(html,/id="admin-view"/);assert.match(admin,/Winner Management/);assert.match(admin,/Preview/);assert.match(admin,/Publish/);assert.match(profile,/getPublishedWinner/);assert.match(rules,/tie breaker/i);assert.match(rules,/diskualifikasi/i);
